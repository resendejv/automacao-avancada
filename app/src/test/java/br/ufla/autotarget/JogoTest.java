...
public class JogoTest {
    ...
    public void testDistanciaCalculadaCorretamenteNoProjetil() throws JogoException {
        ...
        // Criando projétil exatamente onde o alvo está, para forçar colisão (dx e dy são irrelevantes aqui)
        Projetil projetil = new Projetil(100, 100, 1.0, 0.0, jogo);
        
        // Como o acesso é protegido, a lógica de colisão no run() marcará o alvo como inativo
        ...
        // Se a distância for verificada e < raio, o projétil se desativa e o alvo também
    ...
    public void testAdicaoDeCanhaoEPolimorfismoDeAlvo() throws JogoException {
        ...
        assertTrue(rapido.velocidade > comum.velocidade);
    }
}
